...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // definir o comportamento de definição do layout da recycleview
        ...
        mainItems.add(new MainItem(3, R.drawable.ic_baseline_vibration_24, R.string.label_vtnc, Color.BLACK));
        ...
        adapter.setListener(id -> {
            switch (id) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    startActivity(new Intent(MainActivity.this, VtncActivity.class));
            }
        });
        //definir um adaptador
